 <div class="modal fade" id="bayarPiutang" role="dialog">
   <div class="modal-dialog modal-lg" style="width: 1100px;">
    ...
    <div class="modal-content">
      <div class="modal-header" style="background-color: #4db6ac;">
        ...
        <h3 class="modal-title" style="color:white;">Form Pembayaran Piutang</h3>
         ...
         <div class="col-md-3">
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <form action="{{url('KASIR/bayarPiutang')}}" method="post">
                {{csrf_field()}}
                <input type="hidden" class="form-control col-md-5" readonly="" value="Pembayaran Piutang" name="jnstransaksi" id="jnstransaksi" >

                <div class="form-group" id="">
                  <label>Nama</label>
                  <input type="text"  readonly="" class="form-control" placeholder="nama pasien sesuai id" name="" id="nama">
                </div>
          ...
          <div class="col-md-5">
            <div class="box box-warning">
              ...
              <div class="box-body">
                <input type="hidden"  readonly="" class="form-control" name="idpiutang" id="idpiutang">
                <!-- ini berisi id user -->
                  <input type="hidden" readonly="" class="form-control col-md-5" value="{{Auth::user()->id}}" name="user" id="">
                <!-- ini id pendaf -->
                  <input type="text" readonly="" class="form-control"  value="" name="id_pendaf" id="id_pendaf">

                  <input type="text" readonly="" class="form-control"  value="" name="id_supplier" id="id_supplier">


                <div class="form-group col-md-12">
                  <label><strong>Tagihan</strong></label>

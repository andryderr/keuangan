 <div class="modal fade" id="tambahKasMasuk" role="dialog">
   <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header" style="background-color: #4db6ac;">
        ...
        <h3 class="modal-title" style="color:white;">Form Kas Masuk</h3>
        ...
        <div class="box-body">
          <div class="col-md-6">
            <div class="box box-warning">
              ...
              <form action="{{url('KASIR/tambahKasMasuk')}}" method="post">
              {{csrf_field()}}
              <div class="box-body">
                <div class="form-group col-md-12">
                  <label>Tgl. Kas Masuk</label>
                  <input type="text" class="form-control col-md-5" name="tgl_kas" id="tanggalwaktukasmasuk" >
                </div>
                <div class="form-group col-md-12 ">
                  <label>Akun</label>

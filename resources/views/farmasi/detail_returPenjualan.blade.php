    ...
    <div class="content-wrapper">
      ...
      <div class="container-fluid">
       ...
       <section class="content">
        ...
        <form class="" action="{{url('FARMASI/returObat/updateMasterReturPenjualan')}}" method="post"> 
          {{csrf_field()}}    
          <div class="col-md-4">
            <div class="box box-warning">
              ...
              <div class="box-body">
               ...
               <div class="form-group col-md-6">
                ...
                <input type="number"  class="form-control" placeholder="" readonly="" name="id_retur" id=""  value="{{$data[0]->id_retur_pen}}">
              </div>

              <div class="form-group col-md-6">
                <label>Tanggal Retur</label>
                <input type="text"  class="form-control" placeholder="" readonly name="tgl_retur" id="tgl_retur" 
                value="{{$data[0]->tanggal_retur}}">
              </div>


              <div class="form-group col-md-12">
                <label>Keterangan</label>
                <textarea name="keterangan" readonly="" class="form-control" rowspan ="3">{{$data[0]->keterangan}}</textarea>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
             <div class="form-group">
                ...
                <input type="hidden" style="width:120px;" type="hidden" readonly="" class="form-control" placeholder="" name="id_customer" id="id_customer" value="{{$data[0]->pen->kat_pembeli}}">
              </div>

              <div class="input-group">
                <span class="input-group-addon" style="padding-right:27px">Nama Customer</span>
                <input type="text"  class="form-control" placeholder="" readonly name="" id="nama_customer" value="{{$data[0]->pen->kat_pembeli}}">
              </div>
              <br>

              <div class="input-group">
                <span class="input-group-addon">Tanggal Penjualan</span>
                <input type="text"  class="form-control" placeholder="" readonly name="tgl_penjualan" id="tgl_penjualan" value="{{$data[0]->pen->tanggal_penjualan}}">  
              </div>
              <br>

              <div class="input-group">
                <span class="input-group-addon" style="padding-right:48px">Nomer Entri</span>
                <input type="text"  class="form-control" placeholder="" readonly name="id_penjualan" id="id_penjualan" value="{{$data[0]->pen->id_penjualan_barang}}">
              </div>
              <br>
            </div>
          </div>
        ...
        <div class="col-md-4">
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="form-group">
                <!-- <label>ID Supplier</label> -->
                <input type="hidden" style="width:120px;" type="hidden" readonly="" class="form-control" placeholder="" name="id_dokter" id="id_dokter" value="{{$data[0]->pen->id_dokter}}">
              </div>

              <div class="input-group">
                <span class="input-group-addon" style="padding-right:42px">No Resep</span>
                <input type="text"  class="form-control" placeholder="" readonly name="" id="no_resep" value="{{$data[0]->pen->id_resep}}">
              </div>
              <br>

              <div class="input-group">
                <span class="input-group-addon">Tanggal Resep</span>
                <input type="text"  class="form-control" placeholder="" readonly name="tgl_resep" id="tgl_resep" value="{{$data[0]->pen->tanggal_resep}}">  
              </div>
              <br>

              <div class="input-group">
                <span class="input-group-addon" style="padding-right:23px">Nama Dokter</span>
                <input type="text"  class="form-control" placeholder="" readonly name="nama_dokter" id="nama_dokter" value="{{$data[0]->pen->dok->nama}}">
              </div>
              <br>

              <div class="input-group">
                <span class="input-group-addon" style="padding-right:14px">ID Pendaftaran</span>
                <input type="text"  class="form-control" placeholder="" value="1" readonly name="id_pendaftaran" id="id_pendaftaran">
              </div>
              <br>
            </div>
          </div>
              ...
              <div class="table-responsive">
               <table id="" class="" width="100%">
                ...
                <tbody>
                  <tbody>
                    <?php $no=1; $subtot = 0;?>
                    @foreach($data[0]->pen->detpen as $dp)
                    <tr style="font-size: 13px;">
                      ...
                      <td>     
                       @if($data[0]->netto == 0)                                            
                       <a onclick="setEditRetur('{{$dp->id_barang}}','{{$dp->barang->nama_barang}}','{{$dp->harga}}','{{$dp->satuan}}','{{$dp->jumlah}}','{{$dp->diskon_rp1}}','{{$dp->diskon_rp2}}','{{$dp->diskon_rp}}','{{$dp->sub_total}}','{{$dp->biaya_racik}}','{{$dp->biaya_resep}}','{{$dp->barang->stok}}');"><button type="button" data-toggle="modal" data-target="#tambahreturpenjualan"; style="margin-bottom:5px; margin-top: 5px;" class="btn btn-primary btn-sm"><i class="fa fa-cart-arrow-down"></i></button></a>
                       @else
                       @endif
                     </td>
            ...
            <tbody>
              <tbody>
                ...
                <tr style="font-size: 13px;">
                  ...
                  <td>{{$drp->jumlah}}</td>
                  <td>{{$drp->harga}}</td>
                  <td>{{$drp->biaya_racik}}</td>
                  <td>{{$drp->biaya_resep}}</td>
                  <td>{{$drp->diskon_rp}}</td>
                  ...
                  <td>             
                   @if($data[0]->netto == 0)
                   <a href="/FARMASI/hapusDetailReturPenjualan/{{$drp->id_detail_retur}}"><button type="button" onclick="return confirm('Hapus Data Ini ?');" style="margin-bottom:5px; margin-top: 5px;" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button></a>
                   @else
                   @endif                                    
                 </td>
    ...
    <div class="box box-warning">
      ...
      <div class="box-body">
        <div class="form-group col-md-3">
          ...
          <input type="number" class="form-control" placeholder="%" name="" id="diskonpersen" onkeyup="hasilNetto1();">
        </div>
        ...
        <div class="form-group col-md-5">
          <label>Discount Rp</label>
          <input type="number" class="form-control" placeholder"Rp" name="" id="diskonrp" onkeyup="hasilNetto1();" onkeyup="inputTitikRupiah();">
        </div>

        <div class="form-group col-md-6">
          <label>PPN %</label>
          <input placeholder="%" type="number" class="form-control"  name="ppnpersen" id="ppnpersen" onkeyup="hasilNetto1();">
        </div>

        <div class="form-group col-md-6">
          <label>PPN Rp</label>
          <input type="number" readonly="" class="form-control"  name="ppnrupiah" id="ppnrp" onkeyup="hasilNetto1();">
        </div>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
       <div class="form-group">
        ...
        <select class="form-control" name="kat_bayar" id="katPenjualan" onclick="pembayaran2();">
...
@extends('farmasi.mod_tambahItemReturPenjualan')
<script>
...
<script>
  function pembayaran2()
  {
    if (document.getElementById("katPenjualan").value == "Kredit") {
...
<script>
  function setSubtotalItem(){ 
    var hargaItem = document.getElementById("harga_item").innerHTML;
    var qty_item = document.getElementById("qty_retur").value;
    var subtotal_item  = hargaItem *qty_item;
    document.getElementById("subtotal_item").innerHTML= subtotal_item;
  }
</script>

<script>
 function setEditRetur($id_barang, $nama_barang, $harga, $satuan ,$quantity, $diskon1, $diskon2, $diskonrp, $subtotal,$biaya_racik,$biaya_resep,$stok){
  ...
  document.getElementById("biaya_racik").value = $biaya_racik;
  document.getElementById("biaya_resep").value = $biaya_resep;

              ...
              <table id="returpenjualan" class="table table-striped table-bordered" cellspacing="0">
               ...
               <tbody>
                ...
                <tr>
                  ...
                  <td>{{$pen->pen->cust->nama_cust}}</td>
                  <td>{{$pen->tanggal_retur}}</td>
                  <td>{{$pen->keterangan}}</td>
                  <td>{{$pen->netto}}</td>
                  <td>                          
                   @if($pen->netto == null)         
                   <a href="{{url('/FARMASI/returPenjualan/detailReturPenjualan')}}/{{$pen->id_retur_pen}}"><button type="button" class="btn btn-primary"><i class="fa fa-shopping-cart"></i></button></a>
                   <a href="{{url('/FARMASI/hapusMasterReturPenjualan')}}/{{$pen->id_retur_pen}}" onclick="return confirm('Hapus Data Ini ?');"><button type="button" class="btn btn-danger"><i class="fa fa-trash"></i></button></a>
                   @else

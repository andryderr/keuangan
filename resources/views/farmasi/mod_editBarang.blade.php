   ...
   <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          <form action="{{url('FARMASI/editObatAlkes')}}" method="post">
            {{csrf_field()}}
            <div class="form-group col-md-6">
              <input type="hidden" class="form-control" placeholder="" name="id_barang" id="id_barang">
            ...
            <div class="form-group col-md-3">
              ...
              <input type="number" required="" class="form-control" value="" placeholder="" name="stok_minimal" id="stok_minimal">
            </div>
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" style="width:150px"  class="form-control" placeholder="Kapasitas" name="kapasitas2" id="kapasitas21">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" style="width:150px"  class="form-control" placeholder="Kapasitas3" name="kapasitas3" id="kapasitas31">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" style="width:150px"  class="form-control" placeholder="Kapasitas" name="kapasitas4" id="kapasitas41">
            ...
            <div class="form-group col-md-3">
              ...
              <select class="form-control" name="id_subgrup" id="id_subgrup">

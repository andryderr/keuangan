...
<body class="hold-transition skin-blue fixed sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <div class="container-fluid">
       ...
       <section class="content">
        ...
        <form method="post" action="{{url('FARMASI/simpanMasterPenjualan')}}">
          {{csrf_field()}}
          <div class="col-md-6">
              ...
              <div class="box-body">
               <div class="form-horizontal">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7">
                    <input type="text"  class="form-control" placeholder="Ini Kasih Nama Pegawai (User)" readonly name="" id="nama_pegawai" value="{{Auth::user()->name}}">
                  </div>
                </div>
            ...
            <div class="box-body">
              <div class="form-horizontal">
               <div class="form-group">
                 ...
                 <div class="col-md-7">
                  @if($status == 1)
                  <input type="text"  class="form-control" readonly name="id_resep" id="id_resep" value="{{$dataMaster[0]->id_resep}}">
                  @else
                  <input type="text"  class="form-control" readonly name="id_resep" id="id_resep" value="{{$data[0]->id_resep}}">
                  @endif
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-7">
                  ...
                  @else
                  <input type="text"  class="form-control" value="{{$data[0]->tanggal_resep}}" name="tanggal_resep" id="" readonly=""> 
                  @endif
                </div>
              </div>

              <div class="form-group">
                <label for="" class="col-md-5 control-label"> Nama Dokter</label>
                <div class="col-md-7">
                  @if($status == 1)
                  <input type="text"  class="form-control" readonly name="nama_dokter" value="{{$dataMaster[0]->dok->nama}}">
                  @else
                  <input type="text"  class="form-control" readonly name="nama_dokter" value="{{$data[0]->dokter->nama}}">
                  <input type="hidden" name="id_dokter" value="{{$data[0]->id_dokter}}">
                  @endif
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-7">
                  @if($status == 1)
                  <input type="text"  class="form-control" placeholder="Nama Pasien" readonly name="nama_pasien" id="cari_pasien" value="{{$dataMaster[0]->pendaftaran->pasien->nama}}">
                  @else
                  <input type="text"  class="form-control" placeholder="Nama Pasien" readonly name="nama_pasien" id="cari_pasien" value="{{$data[0]->pendaftaran->pasien->nama}}">
                  <input type="hidden" name="id_pendaftaran" value="{{$data[0]->id_pendaftaran}}">
                  @endif
                </div>
              </div>
              <input type="hidden" name="" id="id_pas">
            </div>
          </div>
        </div>
      </div>
    ...
    <form action="{{url('FARMASI/updateMasterPenjualan1')}}" method="post">
      {{csrf_field()}}
      <div class="col-md-12">
        @if($status == 1)
        <div class="box box-primary" id="tabel1">
          ...
          <input type="hidden" value="{{$data[0]->id_resep}}" name="id_resep">
          @else

              ...
              <thead>
                ...
                @foreach($data as $rows)
                  <tr>
                    ...
                    <td>                          
                      <a href="#" data-toggle="tooltip" title="Edit Gudang"><button type="button" data-toggle="modal" data-target="#editGudang" onclick="setModalEdit({{$rows->id_gudang}},'{{$rows->nama_gudang}}','{{$rows->keterangan}}');" class="btn btn-warning"><i class="fa fa-edit"></i></button></a>
                      <a href="{{url(Auth::user()->poli->prefix.'/hapusGudang')}}/{{$rows->id_gudang}}" data-toggle="tooltip" title="Hapus Gudang"><button type="button" onclick="return confirm('Hapus Data Ini ?');" class="btn btn-danger"><i class="fa fa-trash"></i></button></a>
                      <!--  -->
                    </td>
                  </tr>
                  @endforeach

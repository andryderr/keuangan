            ...
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
             ...
             <tbody>
              ...
              <tr>
                ...
                <td>                                       
                  @if($m->netto == null)         
                  <a href="{{url('/FARMASI/returObat')}}/{{$m->id_retur}}" data-toggle="tooltip" title="Retur Pembelian"><button type="button" class="btn btn-primary"><i class="fa fa-shopping-cart"></i></button></a>
                  <a href="/FARMASI/hapusMasterReturPembelian/{{$m->id_retur}}" data-toggle="tooltip" title="Hapus Retur Pembelian" onclick="return confirm('Hapus Data Ini ?');"><button type="button" class="btn btn-danger"><i class="fa fa-trash"></i></button></a>
                  @else

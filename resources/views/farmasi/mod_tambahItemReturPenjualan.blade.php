   ...
   <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          <form action="{{url('FARMASI/returObat/tambahDetailReturPen')}}" method="post">
            {{csrf_field()}}
            <div class="form-group">
              <input type="hidden" class="form-control" readonly="" placeholder="" name="id_bahan" id="idBahan">
            </div>

            <input type="hidden" class="form-control" readonly="" placeholder="" name="id_retur" id="id_retur" value="{{$data[0]->id_retur_pen}}">
          </div>
         ...
         <div class="form-group col-md-3">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="number" class="form-control" readonly="" name="biaya_resep" id="biaya_resep" >
          </div>

          <div class="form-group col-md-6">
            <label>Biaya Racik</label>
            <input type="number" class="form-control" readonly="" name="biaya_racik" id="biaya_racik" >
          </div>

          <div class="form-group col-lg-12">
            <label>Subtotal</label>
            <input type="number"  class="form-control" placeholder="" name="subtotal" readonly="" id="subtotal">
            <!-- /.form group -->

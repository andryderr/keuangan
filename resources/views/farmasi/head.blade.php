...
<head>
    ...
    <script src="{{url('/assets/jquery-ui-1.12.1/jquery-ui.js')}}"></script>
    <script src="{{url('/assets/jquery-ui-1.12.1/jquery-ui.min.js')}}"></script>

    <link rel="stylesheet" href="{{url('/assets/jquery.ui.autocomplete.css')}}">
...
<body class="hold-transition skin-green-light fixed sidebar-mini">
    ...
    <script type="text/javascript">
     ...
     // $('#tambahBeli').on('shown.bs.modal', function (e) {

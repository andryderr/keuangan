          ...
          <div class="box box-default">
            <div class="box-header with-border">
              ...
              <h6 class="alamatRS">Jl. BRAWIJAYA NO. 46-48 MUNCAR Telp.(0333)-590001, HP:0852 597 025 24/ 0878 579 844 50
                ...
                <h3 class="judul1">Laporan Stok Barang</h3>
              ...
              <div class="box-body">
                ...
                <td><label id="jumkecil{{$no}}">{{$stoks->stok}}</label> / {{$stoks->satuan1}}</td>
                <td>{{number_format($stoks->harga,0,".",".")}}</td>
                <td>{{number_format($stoks->harga_jual1,0,".",".")}}</td>
              </tr>
              @endforeach
            </tbody>
          </table>

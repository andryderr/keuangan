                ...
                <!-- form start -->
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="" id="" id="jenisPetugas" class="form-control" placeholder="" readonly="">
                    </div>  

                    <div class="form-group">
                      <label>Persentase Jasa</label>
                      <input type="number"  class="form-control" id="persentasePetugas" placeholder="" name="" id="">
                    </div>  
                </div>
                  </div><!-- /.box-body -->                      

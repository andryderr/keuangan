        ...
        <div class="box box-danger">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="text"  class="form-control" placeholder="" readonly name="idTransaksi">
            </div>

            <div class="form-group">
              <label>No/ID Rekam Medis</label>
              <input type="text"  class="form-control" placeholder="" readonly name="idRekamMedis">
            </div>

            <div class="form-group">
              <label>Nama  Pasien</label>
              <input type="text"  class="form-control" placeholder="" name="namaPasien" readonly>
            </div>

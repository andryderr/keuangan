              ...
              <thead>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>2011/04/25</td>
                    <td>                          
                      <a href="#"><button type="button" data-toggle="modal" data-target="#editDokter" class="btn btn-warning"><i class="fa fa-edit"></i></button></a>
...
@extends('rawatInap.mod_tambahDataDokter')
@extends('rawatInap.mod_editDataDokter')
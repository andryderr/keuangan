             ...
             <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{$data->email}}</td>
                  <td >                                                   
                   <a href="{{url('/GIZI/dataBahanBaku')}}/{{$data->id_supplier}}"><button type="button" class="btn btn-primary"><i class="fa fa-shopping-cart"></i></button></a>
                   <a href="#"><button type="button" data-toggle="modal" data-target="#editSupplier" onclick="setModal('{{$data->id_supplier}}', '{{$data->nama_supplier}}', '{{$data->alamat}}', '{{$data->contact_person}}', '{{$data->email}}', '{{$data->no_telp}}', '{{$data->no_hp}}')" class="btn btn-warning"><i class="fa fa-edit"></i></button></a>
                   <a href="{{url('GIZI/hapusSupplier')}}/{{$data->id_supplier}}" onclick="return confirm('Hapus Data Ini ?');"><button type="button" class="btn btn-danger"><i class="fa fa-trash"></i></button></a></button></a>
                 </td>
                 @endForeach
               </tr>

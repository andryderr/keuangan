 <div class="modal fade" id="editPendaftaran" role="dialog">
   <div class="modal-dialog modal-md">
    ...
    <div class="modal-content">
      <form action="{{url('PENDAF/pendaftaran/update')}}" method="post">
        {{csrf_field()}}
          ...
          <div class="box-body">
            <div class="box-body">
              <div class="form-group">
                ...
                <select class="form-control" name="pasien_baru_lama" id="pasien_baru_lama" onChange="hidupmati();">
                  <option>----</option>
              ...
              <div class="form-group">
                <div class="input-group margin">
                  <input type="hidden" class="form-control" id="no_rm" name="no_rm">
                </div><!-- /input-group -->
              </div>

              <div class="form-group">
                <label>Tanggal Daftar</label>
                <input type="date" class="form-control" placeholder="" id="tanggal_daftar" name="tanggal_daftar">
              </div>

              <div class="form-group">
                <label>Kunjungan ke</label>
                <input type="text"  class="form-control" id="kunjungan_ke" name="kunjungan_ke">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text"  class="form-control" placeholder="" id="no_antri" name="no_antri">
              </div>

              <div class="form-group">
                <label>Cara Masuk</label>
                <select class="form-control" id="cara_masuk" onChange="hidupmati();" name="cara_masuk">
                  <option>----</option>
              ...
              <div class="form-group">
                <label>Rujukan</label>
                <input type="text" class="form-control" placeholder="" id="rujukan" name="rujukan">
              </div>

              <div class="form-group">
                <label>Nama Perujuk</label>
                <input type="text" id="nama_perujuk" class="form-control" placeholder="" name="nama_perujuk">
              </div>

              <div class="form-group">
                <label>Tujuan Berobat</label>
                <select class="form-control" id="tujuan_berobat" onChange="hidupmati();">
                  <option>----</option>
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="nama_poli" id="nama_poli">
                  <option>----</option>
                  @foreach($poli as $r)
  ...
  function setIsi($id){
    ...
    $.getJSON(url, function(result){
      if (result.length > 0) {
        ...
        $('#nama_poli').val(result[0]['id_poli']);

    ...
    function hidupmati()
    {
        if (document.getElementById("pasienBaruLama").value == "BARU") {
            document.getElementById("norm").disabled='true';
                        ...
                        // document.getElementById("namakep").style.display="block";
                        document.getElementById("no_kep").style.display="block";
                        document.getElementById("no_se").style.display="block";
                        document.getElementById("jenis_kep").style.display="block";

                        
                    }else if (document.getElementById("pasienBaruLama").value == "LAMA") {
                        document.getElementById("norm").disabled='';

                        // document.getElementById("namakep").style.display="none";
                        document.getElementById("no_kep").style.display="none";
                        document.getElementById("no_se").style.display="none";
                        document.getElementById("jenis_kep").style.display="none";
            ...
            <script src="{{url('ok/js/wow.min.js')}}"></script>

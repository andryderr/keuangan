   ...
   <div class="modal-dialog modal-md">
    ...
    <div class="modal-content">
      <div class="modal-header" style="background-color: #4db6ac;">
        ...
        <h3 class="modal-title" style="color:white;">Form Tambah Dokter</h3>
        <label>Isi Inputan Dibawah:</label>
      </div>
    <form action="{{url('PERSONALIA/Dokter/Tambah')}}" method="post" accept-charset="utf-8">
    {{csrf_field()}}
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="id_job_dokter" id="">
              <option>----</option>
              @foreach($job as $r)

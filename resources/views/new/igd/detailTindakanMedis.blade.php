            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <a href="#"><button type="button" style="margin-top: 25%;" data-toggle="modal" data-target="#editPersen" class="btn btn-warning" onclick="setModPJRS({{$data[0]->id_detail_medis_kamar}},{{$data[0]->rumah_sakit}});"><i class="fa fa-edit"></i></button></a>
                  @endif
                 </td>
                </tr>
                <tr>
        ...
        <div class="box-body table-responsive no-padding">
         ...
         <table class="table table-hover">
          ...
          <tr>
            ...
            <td>{{$row->harga}}</td>
            <td>
             <a href="#"><button type="button" data-toggle="modal" data-target="#editPersenPetugas" class="btn btn-warning" onclick="setIsiPetugas('Dokter',{{$row->persentase}},{{$row->id_tm_d}});"><i class="fa fa-edit"></i></button></a>
         ...
         <tr>
          ...
          <td>{{$row->harga}}</td>
          <td>
           <a href="#"><button type="button" data-toggle="modal" data-target="#editPersenPetugas" onclick="setIsiPetugas('Petugas','{{$row->persentase}}',{{$row->id_tm_p}});" class="btn btn-warning"><i class="fa fa-edit"></i></button></a>

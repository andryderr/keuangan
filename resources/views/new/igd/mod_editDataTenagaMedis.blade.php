              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                  ...
                  <div class="form-group">
                    ...
                    <input type="text"  class="form-control" placeholder="" readonly name="IdPetugasMedis">
                  </div>

                  <div class="form-group">
                    <label>Nama Petugas Medis</label>
                    <input type="text"  class="form-control" placeholder="" readonly name="namaPetugasMedis">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <br>
                     ...
                     <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="" name="kelurahan">
                    </div>
                    <br>

                    <div class="form-group">
                      <label>SIP</label>
                      <input type="file"  class="form-control" placeholder="" name="sip">
                    </div>

                    <div class="form-group">
                      <label>Tanggal Masuk</label>
                      <input type="date"  class="form-control" placeholder="" name="tanggalMasuk">
                    </div>

                    <div class="form-group">
                      <label>Bertugas sebagai</label>
                      <select class="form-control" name="bertugasSebagai">
                        <option>----</option>

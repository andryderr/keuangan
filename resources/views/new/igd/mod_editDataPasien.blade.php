      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            <label>No RM</label>
            <input type="text"  class="form-control" placeholder="" id="no_rm" readonly name="no_rm">
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" id="tanggallahir" class="form-control" placeholder="" name="tanggalLahir">
          </div>

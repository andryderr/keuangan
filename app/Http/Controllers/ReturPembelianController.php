...
use App\DetailReturPembelianTmp;
use App\Pembelian;
...
class ReturPembelianController extends Controller
{
	...
	public function getMasterReturPembelian($id){
		...
		$detail = DetailReturPembelianTmp::where('id_retur','=',$id)->get();
		$barangsama = DetailReturPembelianTmp::select(DB::raw("id_barang as id_bar, sum(jumlah_kecil) as jumlah"))->where('id_retur', '=', $id)->groupBy('id_barang')->get();
	...
	public function tambahDetailReturPembelian(Request $request){
		...
		$data = new DetailReturPembelianTmp;
	...
	public function hapusDetailReturPembelian($id, Request $request){
		$data = DetailReturPembelianTmp::where('id_detail_retur', $id);
		try {
			$data->delete();				

...
class ReturPenjualanController extends Controller
{
	...
	$dataPenjualan = Penjualan::leftJoin('resep_luar','penjualan_barang.id_resep','=','resep_luar.id_resep')
	->leftJoin('dokter','penjualan_barang.id_dokter','=','dokter.id_dokter')
	->leftJoin('pendaftaran','pendaftaran.id_pendaftaran','=','penjualan_barang.id_pendaftaran')
	->leftJoin('pasien','pasien.no_rm','=','pendaftaran.no_rm')
	->where('penjualan_barang.id_penjualan_barang','=',$id)
	->whereIn('penjualan_barang.kat_barang',['Obat','Alat Medis','Psikotropika','Narkotika','Prekursor Farmasi','Obat Tertentu'])
	->select('*','pasien.nama as nama_pasien','dokter.nama as nama_dokter')
	->get();
	...
	public function tambahMasterReturPenjualan(Request $request){
		...
		try {
		 ...
		 return redirect("FARMASI/returPenjualan/detailReturPenjualan/".$data->id);
		// return back();
	}
